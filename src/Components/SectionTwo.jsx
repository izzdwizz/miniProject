				...
				<div className='flex lg:flex-row flex-col gap-[6rem]'>
					<div className='flex flex-col items-start gap-[1.88rem] py-0 px-8  md:w-[32.875rem] bg-white rounded-3xl relative overflow-hidden'>
						...
						<div className='flex flex-row justify-between items-center w-full'>
							<h3 className='text-[#023047] font-[900] text-[1.875rem] text-left leading-[2.8125rem] w-[23.375rem]'>
								Game Design Essentials
							</h3>{' '}
							<span className='flex gap-[0.3rem] items-center justify-center text-[1rem] leading-6 font-[900] '>
